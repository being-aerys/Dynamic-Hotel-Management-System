...
CREATE TABLE `aashish`.`hotel` ( `id` INT NOT NULL AUTO_INCREMENT , `first` TEXT NOT NULL , `last` TEXT NOT NULL , `ph` INT NOT NULL , PRIMARY KEY (`id`) ) ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS 'about' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
  'about' text NOT NULL PRIMARY KEY ('id')
